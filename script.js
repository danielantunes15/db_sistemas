// Dados iniciais (seriam substituídos por dados do localStorage ou API)
let sites = JSON.parse(localStorage.getItem('sites')) || [
    {
        ...
        description: "Minha loja online de produtos diversos",
        status: "online"
    },
    {
        id: 2,
        ...
        siteCard.innerHTML = `
            ...
            <div class="site-body">
                <div class="site-info">
                    ...
                    <p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M6 12.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-1v-7A1.5 1.5 0 0 0 7.5 1h-1A1.5 1.5 0 0 0 5 2.5v7h-1a.5.5 0 0 0-.5.5v2ZM6 14v1a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-1H6ZM5 2.5A2.5 2.5 0 0 1 7.5 0h1A2.5 2.5 0 0 1 11 2.5v7.085A1.5 1.5 0 0 1 12.5 11h.5a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h.5A1.5 1.5 0 0 1 5 9.585V2.5Z"/>
                        </svg>
                        ${site.supabaseUrl}
                    </p>
...
function openEditModal(siteId) {
    ...
    document.getElementById('supabase-key').value = site.supabaseKey;
